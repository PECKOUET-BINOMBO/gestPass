            ...
            <div className="flex items-strech">
              ...
              <div className="p-10 md:p-10 shadow rounded w-8/12 ms-3">
                <form className="space-y-4" action="#" method="POST">
                  ...
                  <button
                    type="submit"
                    className="mt-5 w-50 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                  >
                    Mettre à jour
                  </button>
                </form>
